...
function bemReactCore(options, BaseComponent, classNameBuilder) {
    ...
    function applyEntityDecls() {
        ...
        if (entity.decls) {
            entity.decls.forEach(function (_a) {
                ...
                entity.cls ? inherit.self(entity.cls, fields, staticFields) : entity.cls = inherit(entity.base ? entity.base : BaseComponent, fields, Object.assign({
        ...
        if (entity.modDecls) {
            ...
            entity.modDecls.forEach(function (_a) {
                ...
                var _loop_1 = function (name_1) {
                    ...
                    typeof field === 'function' && (fields[name_1] = function () {
                        var method;
                        if (predicate.call(this, this.props)) {
                            method = field;
                        } else {
                            var baseMethod = ptp_1[name_1];
                            baseMethod && baseMethod !== field && (method = this.__base);
                        }
    ...
    return {
        decl: function (base, fields, staticFields) {
            ...
            if (base) {
                if (entity.base) throw new Error("BEM-entity \"" + key + "\" has multiple ancestors");
                entity.base = base;
            }
...
function wrapWithFunction(obj, name) {
    if (Array.isArray(name)) {
        ...
        if (obj.hasOwnProperty(name)) {
            var val_1 = obj[name];
            typeof val_1 !== 'function' && (obj[name] = function () {
                return val_1;
            });
        }
    }
...
function fixHooks(obj) {
    for (var oldName in lifecycleHooks) if (obj[oldName]) {
